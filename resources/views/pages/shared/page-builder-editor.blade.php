{{--
    The page-builder editor body, shared by the platform admin (Manage Pages) and the
    reseller website builder. Everything that differs between the two — the save/preview/meta
    endpoints, the create-vs-edit mode, the public URL base — arrives pre-built in
    $pageBuilderPayload, which the JS pageBuilder() component reads from window.__PAGE_BUILDER__.
    The only Blade-level differences are passed in as variables so this file never names a
    route directly:

      $pageBuilderPayload  array  the full JS payload (built by the including view)
      $widgetDefinitions   array  widget palette definitions
      $layoutHeading       string breadcrumb / heading
      $isCreateMode        bool
      $page                ?Page  the page being edited (null in create mode)
      $indexUrl            string  where the "back to list" button goes
      $publicUrl           ?string the live URL of this page (edit mode only)
--}}
@php
                        ...
                        <div x-show="propTab === 'advanced'" x-cloak class="space-y-5">
                            ...
                            <div class="border-t border-gray-200 pt-4 dark:border-gray-700 space-y-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-[11px] text-gray-400 dark:text-gray-500">Lets links jump to this section: <span class="font-mono">#our-story</span></p>
                                </div>
                                <div>
