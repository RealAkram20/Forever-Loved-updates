    ...
    <div class="mb-6 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-white/[0.03] p-4">
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="shrink-0 flex items-center gap-3">
                ...
                <a href="{{ $memorial->publicUrl() }}" target="_blank" rel="noopener noreferrer" class="btn btn-secondary btn-md">
            ...
            <x-common.component-card title="Settings">
                <div class="space-y-5" data-section="settings">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="plan" value="{{ $memorial->plan ?? 'free' }}" />
                        <div class="flex flex-wrap items-center gap-3">
                            @php $currentPlan = $memorial->plan ?? 'free'; @endphp
                            <span class="inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold
                                {{ $currentPlan === 'paid' ? 'bg-brand-100 text-brand-700 dark:bg-brand-900/30 dark:text-brand-400' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-300' }}">
                                {{ ucfirst($currentPlan) }}
                            </span>
                            @if($currentPlan !== 'paid')
