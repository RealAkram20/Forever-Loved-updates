        ...
        <x-common.component-card title="{{ $memorial->full_name }}">
            <div class="space-y-4">
                ...
                @if ($memorial->biography)
                    <div>
                        <p class="text-sm text-gray-500">Biography</p>
                        <p class="whitespace-pre-wrap">{{ $memorial->biography }}</p>
                    </div>
                @endif
                <div>
                    <p class="text-sm text-gray-500">Theme</p>
                    <p class="font-medium">{{ ucfirst($memorial->theme) }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-500">Visibility</p>
                    <p class="font-medium">{{ $memorial->is_public ? 'Public' : 'Private' }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-500">Public URL</p>
                    <p class="font-mono text-sm">/{{ $memorial->slug }}</p>
