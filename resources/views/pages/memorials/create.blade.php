                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <textarea id="major_achievements" name="major_achievements" rows="3" placeholder="e.g. Co-founded Apple Inc. with Steve Wozniak in 1976..."
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden">{{ old('major_achievements') }}</textarea>
                    </div>
                    <div>
            ...
            <x-common.component-card title="Settings">
                <div class="space-y-5">
                    <div>
                        ...
                        <div class="relative z-20 bg-transparent">
                            <select name="theme"
                                ...
                                <option value="free" {{ old('theme', 'free') === 'free' ? 'selected' : '' }}>Classic</option>
                                ...
                                <option value="garden" {{ old('theme') === 'garden' ? 'selected' : '' }}>Garden</option>
                            </select>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap items-center gap-6">
                            <label class="flex cursor-pointer items-center text-sm font-medium text-gray-700 select-none">
                                <input type="radio" name="plan" value="free" {{ old('plan', 'free') === 'free' ? 'checked' : '' }}
                                    class="border-gray-300 text-brand-600 focus:ring-brand-500" />
                                <span class="ml-2">Free</span>
                            </label>
                            <label class="flex cursor-pointer items-center text-sm font-medium text-gray-700 select-none">
                                <input type="radio" name="plan" value="paid" {{ old('plan') === 'paid' ? 'checked' : '' }}
                                    class="border-gray-300 text-brand-600 focus:ring-brand-500" />
