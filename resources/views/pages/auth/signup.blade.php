                    ...
                    <div>
                        ...
                        @if (\App\Helpers\SocialLoginHelper::googleLoginEnabled())
                            <a href="{{ route('google.redirect') }}"
                                class="mb-0 inline-flex w-full items-center justify-center gap-3 rounded-lg bg-gray-100 px-7 py-3 text-sm font-normal text-gray-700 transition-colors hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10">
