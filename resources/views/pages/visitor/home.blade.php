...
{{-- Hero Section --}}
<section class="relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-brand-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute -top-24 -right-24 h-96 w-96 rounded-full bg-brand-500/5 blur-3xl dark:bg-brand-500/10"></div>
        <div class="absolute -bottom-24 -left-24 h-96 w-96 rounded-full bg-brand-500/5 blur-3xl dark:bg-brand-500/10"></div>
    </div>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="{{ route('memorial.public', $memorial->slug) }}"
                       class="group block rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800/50 p-4 transition hover:shadow-lg hover:border-brand-200 dark:hover:border-brand-800">
...
<section id="features" class="bg-gray-50 dark:bg-gray-800/50 py-16 sm:py-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {{-- Card 1 --}}
            <div class="rounded-2xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 transition hover:shadow-md">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <a href="{{ route('memorial.directory') }}?designation={{ urlencode($designation['value']) }}"
               class="group flex items-center gap-4 rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800/50 p-5 transition hover:shadow-md hover:border-brand-200 dark:hover:border-brand-800">
...
{{-- CTA Section --}}
<section class="relative overflow-hidden bg-brand-500 dark:bg-brand-600 py-16 sm:py-20">
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    <div class="relative mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div class="mt-8 flex flex-wrap justify-center gap-4">
            <a href="{{ route('memorial.create.step1') }}"
               class="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3.5 text-sm font-semibold text-brand-600 shadow-lg hover:bg-gray-50 transition">
                Get Started Free
            </a>
