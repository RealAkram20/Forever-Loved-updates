...
@section('content')
            ...
            <div class="xl:col-span-5">
                ...
                <div class="mt-6 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-white/[0.03] p-5">
                    ...
                    <div class="grid grid-cols-1 2xsm:grid-cols-2 gap-3">
                        ...
                        <a href="{{ route('settings.pages.index') }}" class="flex items-center gap-2.5 rounded-xl border border-gray-200 dark:border-gray-700 p-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/[0.03] transition">
                            <svg class="w-5 h-5 text-sky-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                            Pages
                        </a>
                        <a href="{{ route('settings.pages.edit', \App\Models\Page::SLUG_VISITOR_HOME) }}" class="flex items-center gap-2.5 rounded-xl border border-gray-200 dark:border-gray-700 p-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/[0.03] transition">
                        ...
                        <a href="{{ route('settings.menus.edit') }}" class="flex items-center gap-2.5 rounded-xl border border-gray-200 dark:border-gray-700 p-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/[0.03] transition">
                            <svg class="w-5 h-5 text-teal-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 6h16M4 12h16M4 18h7"/></svg>
                            Menus
                        </a>
                        ...
                        <a href="{{ route('settings.payment-orders') }}" class="flex items-center gap-2.5 rounded-xl border border-gray-200 dark:border-gray-700 p-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/[0.03] transition">
    ...
    @elseif (!$isAdmin)
        ...
        <div class="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-white/[0.03] p-8 text-center">
            ...
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90 mb-2">Welcome to {{ \App\Helpers\SiteShareMetaHelper::appDisplayName() }}</h3>
