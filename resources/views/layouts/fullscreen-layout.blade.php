...
window.addEventListener('resize', checkMobile);">
    ...
    {{-- Theme FAB: omit on views that already expose toggle in <x-home-header /> (pass hideFullscreenThemeToggle from @extends) --}}
    @if (empty($hideFullscreenThemeToggle))
    <div class="fixed bottom-6 right-6 z-[100] max-[380px]:bottom-20">
        <button type="button"
            class="inline-flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-600 shadow-sm transition hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
            @click.prevent="$store.theme.toggle()"
            aria-label="Toggle light or dark mode">
            <svg class="hidden h-5 w-5 fill-current dark:block" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <svg class="h-5 w-5 fill-current dark:hidden" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
