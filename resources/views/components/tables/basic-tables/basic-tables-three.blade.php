    ...
    <div class="rounded-2xl border border-gray-200 bg-white pt-4">
        ...
        <div class="px-6 py-4 border-t border-gray-200">
            <div class="flex items-center justify-between">
                <button @click="prevPage" :disabled="currentPage === 1" :class="currentPage === 1 ? 'opacity-50 cursor-not-allowed' : ''" class="btn btn-secondary btn-md">
                ...
                <button @click="nextPage" :disabled="currentPage === totalPages" :class="currentPage === totalPages ? 'opacity-50 cursor-not-allowed' : ''" class="btn btn-secondary btn-md">
